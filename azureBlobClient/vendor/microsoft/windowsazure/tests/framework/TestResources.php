...
class TestResources
{
    ...
    const QUEUE_URI     = '.queue.core.chinacloudapi.cn';
    const URI1          = "http://myaccount.queue.core.chinacloudapi.cn/myqueue";
    const URI2          = "http://myaccount.queue.core.chinacloudapi.cn/?comp=list";
    ...
    public static function listQueuesOneEntry()
    {
        ...
        $sample['MaxResults'] = '2';
        $sample['Queues'] = array('Queue' => array('Name' => 'myqueue', 'Url' => 'http://account.queue.core.chinacloudapi.cn/myqueue'));
        $sample['NextMarker'] = '';
    ...
    public static function listQueuesMultipleEntries()
    {
        ...
        $sample['Queues'] = array ('Queue' => array(
          0 => array('Name' => 'myqueue1', 'Url' => 'http://account.queue.core.chinacloudapi.cn/myqueue1'),
          1 => array('Name' => 'myqueue2', 'Url' => 'http://account.queue.core.chinacloudapi.cn/myqueue2')
        ));
    ...
    public static function listContainersOneEntry()
    {
        ...
        $sample['Containers'] = array('Container' => array(
            'Name' => 'audio',
            'Url' => 'http://myaccount.blob.core.chinacloudapi.cn/audio',
            'Properties' => array(
    ...
    public static function listContainersMultipleEntries()
    {
        ...
        $sample['Containers'] = array ('Container' => array(
          ...
          1 => array(
            'Name' => 'images',
            'Url' => 'http://myaccount.blob.core.chinacloudapi.cn/images',
            'Properties' => array(
                'Last-Modified' => 'Wed, 12 Aug 2009 20:39:39 GMT',
    ...
    public static function listBlobsOneEntry()
    {
        ...
        $sample['Blobs'] = array(
            ...
            'Blob' => array(
                'Name' => 'myblob',
                'Url' => 'http://account.blob.core.chinacloudapi.cn/myblob',
                'Snapshot' => '10-12-2011',
    ...
    public static function listBlobsMultipleEntries()
    {
        ...
        $sample['Blobs'] = array(
            ...
            1 => array(
                'Name' => 'myblob2',
                'Url' => 'http://account.blob.core.chinacloudapi.cn/myblob2',
                'Snapshot' => '10-12-2011',
                'Metadata' => array('Name1' => 'Value1', 'Name2' => 'Value2'),
                'Properties' => array(
    ...
    public static function getTestOAuthAccessToken()
    {
        $token = array(
            Resources::OAUTH_ACCESS_TOKEN => 'http%3a%2f%2fschemas.xmlsoap.org%2fws%2f2005%2f05%2fidentity%2fclaims%2fnameidentifier=client_id&http%3a%2f%2fschemas.microsoft.com%2f'
                . 'accesscontrolservice%2f2010%2f07%2fclaims%2fidentityprovider=https%3a%2f%2fwamsprodglobal001acs.accesscontrol.chinacloudapi.cn%2f&Audience=urn%3aWindows'
                . 'AzureMediaServices&ExpiresOn=1326498007&Issuer=https%3a%2f%2f wamsprodglobal001acs.accesscontrol.chinacloudapi.cn%2f&HMACSHA256=hV1WF7sTe%2ffoHqzK%2ftm'
