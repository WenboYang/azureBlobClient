...
class Resources
{
    ...
    const ASTERISK               = '*';
    const SERVICE_MANAGEMENT_URL = 'https://management.core.chinacloudapi.cn';
    ...
    const WRAP_ENDPOINT_URI_FORMAT = "https://%s-sb.accesscontrol.chinacloudapi.cn/WRAPv0.9";
    ...
    // Media services
    const MEDIA_SERVICES_URL = 'https://media.chinacloudapi.cn/API/';
    const MEDIA_SERVICES_OAUTH_URL = 'https://wamsprodglobal001acs.accesscontrol.chinacloudapi.cn/v2/OAuth2-13';
