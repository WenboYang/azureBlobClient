...
if ('/home/wb/host/azureBlobClient/vendor/pear-pear.php.net/PEAR ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('/home/wb/host/azureBlobClient/vendor/pear-pear.php.net/PEAR '));
    $raw = false;
} else {
